...
public:
	...
	*/
	...
	/*
	USAGE: Rotates the camera direction
	ARGUMENTS: float a_fAngleX = 0.1f, float a_fAngleY = 0.1f -> amount of rotation
	OUTPUT: ---
	*/
	void RotateCamera(float a_fAngleX = 0.1f, float a_fAngleY = 0.1f);
